...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>转让订单</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索筛选 -->
    <el-form :inline="true"
             :model="formInline"
      ...
      <el-form-item>
        <el-select size="small"
                   ...
                   placeholder="请选择">
          <el-option v-for="type in payway"
                     :label="type.key"
                     :value="type.value"
                     :key="type.value"></el-option>
        </el-select>
    ...
    <el-table size="small"
      ...
      <el-table-column align="center"
        ...
        <template slot-scope="scope">
          ...
          <el-button size="mini"
                     type="danger"
                     @click="deleteUser(scope.$index, scope.row)">退款</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
